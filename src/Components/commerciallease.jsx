...
// const Commerciallease = ({  activeButton,
//   user,
//   first,
//   second,
//   selectedPropType, }) => {
...
//       errors.leaseprice = "Please enter least price";
//     }
...
//     formData.append("leaseamount", parseInt(formValue?.leaseprice));
...
// import axios from "axios";
// import { Baseurl, UserConfig } from "./request";
// const Commercialrent = ({  activeButton,
//   user,
//   first,
//   second,
//   selectedPropType,}) => {
...
//             />
//             <select
//              className='rounded-end down border-start-0 ps-5' style={{ position: 'absolute', top: 0, right: 0, width: '100px', height: '100%',}}>
//   <option>ft</option>
//   <option>mt</option>
// </select>
// </div>
