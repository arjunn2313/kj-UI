...
const formControlStyle = {
      ...
      <Row className="gx-md-3 mt-5">
        ...
        <Col md={6}>
          <Form.Group controlId="formGroup5">
            ...
            <Form.Control type="number" placeholder="Number of Units in the Project" style={{ ...formControlStyle }} />
          </Form.Group>
        </Col>
        <Col md={6}>
          <Form.Group controlId="formGroup6">
            <Form.Label> Floor No.</Form.Label>
            <Form.Control type="number" placeholder="Floor No" style={{ ...formControlStyle }} />
          </Form.Group>
        </Col>
      </Row>
 ...
 <div className='custom-radio d-flex mt-4'>
  ...
  <div className="flex-grow-1 me-3">
   <input className="inp" placeholder="If under construction, then possession by months" style={{ textAlign: 'left' }} />
   </div>
