...
const handleview = (e) =>{
  ...
  e.preventDefault();
  request.post('createproperty/', formValue).then((resp) => {
...
const removeSelectedLogo = () => {
 ...
 <Form className=" mx-2">
   ...
   <li className="nav-item mx-5">
     <a className={`nav-link ${upload === "Logo" ? 'design' : ''}`}  style={navLinkStyle} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} 
...
{upload === 'Logo' && 
  ...
  <button type="button" className="buttonmobile mt-5"style={{width:"370px"}} onClick={()=>handleview('Post Property')}>Post Property</button>
</div>
