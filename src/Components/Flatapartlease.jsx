...
const Flatapartlease = ({activeButton}) => {
      ...
      <div>
        <Form className="mx-3">
          ...
          <Form.Group controlId="propertyLocation">
            ...
            <Form.Control type="text" placeholder="Enter Property Location" style={{ ...formControlStyle}} />
          </Form.Group>
        </Col>
          </Row>
          ...
          <Row className="gx-md-3 mt-5">
            ...
            <Col md={6}>
              <Form.Group controlId="formGroup5">
                <Form.Label>Built Up Area <span className='month'>(Onwards)</span> </Form.Label>
  ...
  <option>mt</option>
            ...
            <Col md={6}>
              <Form.Group controlId="formGroup6">
                ...
                <Form.Control type="number" placeholder="Area" style={{ ...formControlStyle }} />
              </Form.Group>
            </Col>
          </Row>
          <Row className="gx-md-3 mt-5">
            ...
            <Col md={6}>
              <Form.Group controlId="formGroup5">
                ...
                <Form.Control type="number" placeholder="Built Up Area" style={{ ...formControlStyle }} />
              </Form.Group>
            </Col>
            <Col md={6}>
              <Form.Group controlId="formGroup6">
