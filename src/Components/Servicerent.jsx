...
// const Servicerent = ({ activeButton }) => {
...
// const Servicesell = ({ activeButton, user,
//   first,
//   second,
//   selectedPropType, }) => {
...
//   formData.append("industrialbuilding.built_up_area", parseInt(formValue?.area));
//   formData.append("industrialbuilding.built_up_area_unit", "sqft");
//   formData.append("industrialbuilding.address", formValue?.address);
//   formData.append("industrialbuilding.available_floors", parseInt(formValue?.floors));
//   formData.append("industrialbuilding.plot_area", parseInt(formValue?.plotarea));
//   formData.append("industrialbuilding.plot_area_unit", "sqft");
//   formData.append("industrialbuilding.road_width", formValue?.roadwidth);
...
//     formData.append(
//       `showroom.land_zone[${index}]facility.name`,
//       element
//     );
//   });
//   if (selectedImage) {
...
four,
  ...
  const validateFormData = (data) => {
    ...
    if (!data.rentPrice.trim()) {
      errors.rentPrice = "Please enter sale price";
    }
    if (!data.advanceAmount.trim()) {
      errors.advanceAmount = "Please enter advance amount";
    }
