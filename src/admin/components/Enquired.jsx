...
function Enquired() {
  ...
  const handleSearchChange = (value) => {
    setSearch(value);
    fetchProperties(`http://127.0.0.1:8000/api/basic_enquired_properties/?page=1&page_size=10&search=${value}`);
  };
  ...
  //   if (value !== '') {
  //     setStatus(value);
  //     fetchProperties(`http://127.0.0.1:8000/api/basic_enquired_properties/?page=1&page_size=10&status=${value}`);
  //   } else {
  //     setStatus('');
  //     fetchProperties(`http://127.0.0.1:8000/api/basic_enquired_properties/?page=1&page_size=10`);
  //   }
  // };
...
function getColor(propertyType) {
  switch (propertyType) {
    case 'rent':
      return 'green';
    case 'sell':
